 ...
 *
 * Conversation steps:
 *   START     → greet + ask for name/phone to identify
 *   IDENTIFY  → match patient, show their name
 *   PROCEDURE → pick procedure from menu
 *   DATE      → enter preferred date (e.g. "tomorrow" or "15 April")
 *   TIME      → show available slots, pick one
 *   CONFIRM   → show summary, reply YES to book
 *   DONE      → appointment created, confirmation sent
 */
